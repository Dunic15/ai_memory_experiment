...
_LEGACY_ARTICLES = {
    ...
    'crispr': {
        ...
        'questions': [
            ...
            {"q": "A major challenge in CRISPR therapy is ensuring that editing components reach the nucleus and act without triggering _______.", "options": ["excessive DNA replication", "immune rejection", "metabolic suppression", "oxidative stress"], "correct": 1},
