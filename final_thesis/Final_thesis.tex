...
% Fallback no-op macros when compiling without the PoliMi template.
...
natural-language interfaces and large-scale decision support \citep{Schmidhuber2022AnnotatedHistoryAI,Shao2022EvolutionAIConnectionistBibliometric,Zhang2020ThirdGenerationAI,Dwivedi2023EvolutionAIResearchTFSC}.
...
generative AI is increasingly used to summarize, prioritize, and communicate \citep{Huryn2024AutomateWorkProductManager,Gupta2024AIUseCasesProductManagers,Nest2024AIProductManagementWorkflows,Gnanasambandam2024GenAIAcelerateTimeToMarket}.
...
governance rather than model deployment alone \citep{Goodwin2024AIinBusinessIBM,Rashid2024AIRevolutionizingIndustries,Luu2024AIApplicationsBestarion,Edlich2018CorporateSupportFunctionsAI,McKinsey2025StateOfAIRewiring,McGrath2024AITransformingOperationsManagementIBM,Nawaz2024AIAdoptionHRM,Bailey2025AIScenarioAnalysisCFI}.
...
on efficiency, judgment, and ethical responsibility. The thesis proposes the
...
potentially hazardous \citep{Huryn2024AutomateWorkProductManager,Gupta2024AIUseCasesProductManagers,Nest2024AIProductManagementWorkflows}.
...
are maintained when AI outputs shape reasoning \citep{Pasquale2015BlackBoxSociety,Trunk2020HumanAIStrategicDecisions}.
...
shifts in responsibility and ethical vigilance.
...
determinants of retrieval fidelity. In this thesis, this motivates treating source monitoring and misinformation
susceptibility as first-class outcomes rather than as peripheral errors \citep{Tulving1972EpisodicSemantic,Johnson1993SourceMonitoring}.
...
multiple paradigms motivates the thesis’s multi-method strategy: rather than assuming one-to-one equivalence between
laboratory tasks and professional practice, the thesis uses Study~1 as mechanistic evidence and Study~2 as contextual
evidence and integrates them via the AI Buffer Model.
...
learning improves when readers actively organize and elaborate content rather than passively re-reading it,
consistent with the Levels of Processing framework \citep{Craik1972LevelsOfProcessing}. Second, even when verbatim
recall does not increase, organizational supports (e.g., structured previews or graphic organizers) can improve
conceptual integration and performance on applied questions \citep{Stull2007GraphicOrganizers}.
...
\citep{Sparrow2011GoogleEffect,Risko2016CognitiveOffloading,Gerlich2025AIToolsSociety}. While such shifts can be
adaptive in complex environments, they can also create dependence on external systems for knowledge continuity and
reduce opportunities for effortful encoding and self-generated retrieval.
...
source-confusability, and fluency \citep{Loftus2005PlantingMisinformation,Chan2024ConversationalAIFalseMemories}. For
AI-assisted cognition, this is a critical framing: when AI outputs are plausible and presented in ways that blur
provenance cues, they can function as post-event information that competes with or overwrites source material in
memory.
...
AI outputs are embedded into workflows and presented with conversational fluency \citep{Kaplan2018SiriSiriAI}.
...
choose appropriate validation strategies \citep{Wang2022AILiteracyScale}. Without such literacy, users may adopt
...
\citep{Trunk2020HumanAIStrategicDecisions,Kaggwa2024AIDecisionMakingFonsahO,Kaggwa2024AIDecisionMakingFonsahT}. In
...
which can shape whether AI augments judgement or induces over-reliance \citep{Wang2023FriendOrFoeAIWorkers}.
...
recommendations enter decision workflows \citep{Huryn2024AutomateWorkProductManager,Gupta2024AIUseCasesProductManagers,Nest2024AIProductManagementWorkflows}.
...
\citep{Trunk2020HumanAIStrategicDecisions,Kamariotou2021AIBusinessStrategySustainability,Li2025TransformingOrganisationsThroughAI}. Industry
...
operations management \citep{McGrath2024AITransformingOperationsManagementIBM}, financial services \citep{Chlouverakis2024AIReshapingFinancialServices},
scenario analysis in corporate finance \citep{Bailey2025AIScenarioAnalysisCFI}, and human-resource
management practices \citep{Nawaz2024AIAdoptionHRM}. In many cases, adoption is paired with automation
technologies such as RPA and workflow tooling, which shift the division of labor by externalizing routine decision
steps into software artifacts \citep{Mangal2023RoleOfRPAandAI,Edlich2018CorporateSupportFunctionsAI}.
...
business-model configurations enabled by algorithmic capabilities \citep{Kaggwa2024AIDecisionMakingFonsahO,Kaggwa2024AIDecisionMakingFonsahT,Jorzik2024AIBusinessModelInnovationReview,Atsmon2023AIinStrategyMcKinsey,Corbo2021ReinforcementLearningCourse,Soni2019ImpactAIOnBusinesses}.
Such changes create new demands for organizational learning and training, including ``hands-on'' AI skill
development in business education and professional contexts \citep{Freire2024ReshapingBusinessEducationAI,Wang2022AILiteracyScale}.
...
\citep{Kucewicz2023BrainStimulationMemory}. In education, intelligent
tutoring systems improve learning outcomes by tailoring practice and feedback
\citep{Ma2014ITSMetaanalysis,Alshaikh2021ITS}, and active learning improves durable
...
cross-functional teams around goals and trade-offs \citep{Tkali2022AgileProductManagement}. These responsibilities make the
...
across fragmented information sources \citep{Huryn2024AutomateWorkProductManager,Gupta2024AIUseCasesProductManagers,Nest2024AIProductManagementWorkflows}. These uses are best understood as a mix of
...
as AI-generated artifacts flow between product, design, and engineering teams \citep{Gnanasambandam2024GenAIAcelerateTimeToMarket}.

These accounts align with a broader business-operations framing in which AI supports both operational efficiency
and strategic exploration \citep{Tarafdar2019AIEnhanceBusinessOperations,Atsmon2023AIinStrategyMcKinsey}. For
...
and appropriately use AI outputs rather than treating them as authoritative \citep{Wang2022AILiteracyScale}.
...
\citep{Tkali2022AgileProductManagement,Huryn2024AutomateWorkProductManager,Gupta2024AIUseCasesProductManagers,Nest2024AIProductManagementWorkflows}. The next chapter introduces the \emph{AI Buffer} model as an integrative
...
\citep{Wang2022AILiteracyScale}. These factors are relevant for both Study~1 (as individual differences) and
...
aligning cross-functional teams around goals and trade-offs \citep{Tkali2022AgileProductManagement}. These responsibilities
...
\citep{Gupta2024AIUseCasesProductManagers,Huryn2024AutomateWorkProductManager,Nest2024AIProductManagementWorkflows}. Typical uses include summarizing customer feedback, drafting product narratives,
...
\begin{itemize}
  ...
  responsibilities; increasing importance of AI literacy \citep{Wang2022AILiteracyScale}.
...
\begin{enumerate}
  ...
  \citep{Nest2024AIProductManagementWorkflows,Huryn2024AutomateWorkProductManager,Wang2023FriendOrFoeAIWorkers}.
  ...
  narrated \citep{Gupta2024AIUseCasesProductManagers,Nest2024AIProductManagementWorkflows,Gnanasambandam2024GenAIAcelerateTimeToMarket}.
  ...
  calibrated reliance and more effective integration of AI into PM workflows \citep{Wang2022AILiteracyScale}.
  ...
  norms, constraints, and maturity of AI deployment \citep{McKinsey2025StateOfAIRewiring,Kamariotou2021AIBusinessStrategySustainability}.
\end{enumerate}
...
of usage, but a configuration of practices and governance structures \citep{McKinsey2025StateOfAIRewiring,Kamariotou2021AIBusinessStrategySustainability,Pai2022AIKnowledgeManagement}.
...
\begin{itemize}
  ...
  comparison aligned with RQ2’s comparative component.
\end{itemize}
...
reflect organizational environments and governance norms \citep{McKinsey2025StateOfAIRewiring,Kamariotou2021AIBusinessStrategySustainability}.
