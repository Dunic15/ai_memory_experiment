...
\graphicspath{{report_assets/}{Final result/report_assets/}}
...
% --------------------------------------------
\subsection{Process Evidence: Pre-reading Increases Summary Engagement Without Increasing Total Time}
% --------------------------------------------
...
% --------------------------------------------
\subsection{Robustness Note (Primary Effects)}
% --------------------------------------------

Robustness checks confirm the primary effects across alternative model specifications and sensitivity analyses (see the Experimental Design Robustness section).
...
\subsection{Article Difficulty Analysis (9.1)}
...
\subsubsection{9.2 Counterbalancing Check}
...
\subsubsection{9.3 Timing $\times$ Article Interaction}
\begin{table}[H]
\centering
\begin{tabular}{lcc}
\toprule
...
\subsubsection{9.4 Leave-One-Article-Out Robustness}
...
\subsection{Main Finding 3: Pre-reading Increases Summary Engagement Without Increasing Total Time}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{report_assets/slide1_main_finding_1_ai_summary_accuracy.png}
        \vspace{2pt}
    ...
    \begin{minipage}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{report_assets/A1_plot_mcq_accuracy.png}
        \vspace{2pt}
    ...
    \begin{minipage}{0.78\linewidth}
        \centering
        \includegraphics[width=\linewidth]{report_assets/A1_plot_article_accuracy.png}
        \vspace{2pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\linewidth]{report_assets/timing_decomposition.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{report_assets/A1_plot_false_lure_accuracy.png}
        \vspace{2pt}
    ...
    \begin{minipage}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{report_assets/ORD_plot2_lure_prob_by_structure.png}
        \vspace{2pt}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{report_assets/A1_plot_summary_time_sec.png}
        \vspace{2pt}
    ...
    \begin{minipage}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{report_assets/A1_plot_summary_prop.png}
        \vspace{2pt}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{report_assets/A1_plot_reading_time_min.png}
        \vspace{2pt}
    ...
    \begin{minipage}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{report_assets/A1_plot_total_time_sec.png}
        \vspace{2pt}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{report_assets/ORD_plot3_article_difficulty.png}
        \vspace{2pt}
    ...
    \begin{minipage}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{report_assets/EXP_fig_counterbalancing_timing_by_article.png}
        \vspace{2pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\linewidth]{report_assets/slide4_robustness_leave_one_article_out.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{report_assets/A1_plot_recall_total_score.png}
        \vspace{2pt}
    ...
    \begin{minipage}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{report_assets/A1_plot_mental_effort.png}
        \vspace{2pt}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{report_assets/F2_plot_overconfidence.png}
        \vspace{2pt}
    ...
    \begin{minipage}{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{report_assets/H3_plot_recall_calibration_by_group.png}
        \vspace{2pt}
